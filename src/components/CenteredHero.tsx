// Enhanced by AI on 2025-08-14T15:10:35.924Z
// Section: hero
// Category: hero
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Explore our curated collection of one-of-a-kind jewelry, handmade by talented local artisans.
              Find the perfect piece to elevate your style and express your personal flair.
            </p>
