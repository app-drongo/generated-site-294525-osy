// Enhanced by AI on 2025-08-14T15:11:08.576Z
// Section: footer
// Category: footer
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Discover the beauty of handcrafted jewelry at Jewel Artisan. Our collection of unique, 
                one-of-a-kind pieces are made with love and care by local artisans.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">456 Jewelry Ln, Suite 200</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get the latest updates on new arrivals and special offers. Unsubscribe anytime.
              </p>
            </div>
          </div>
